---
title: "TMT16 LC-MS initial analysis"
...
Import the data, some uniprot identifiers need to be updated, these are in the 'conversion.txt' file
...
Extract from each cluster the top 10 proteins that show the highest differential expression in that cluster, and plot the protein abundance of those. 
